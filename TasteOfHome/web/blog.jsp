...
<div class="clear"></div>
    ...
    <div class="main" style="margin-top:10px; margin-bottom: 10px;">
		<div class="header" >
            ...
            String desp,bname,bimg;
            int bid=0;
            String q="select * from tbblog";
           java.sql.PreparedStatement pst=obj.db.prepareStatement(q);
            ...
            {  
                ...
                bimg=rs.getString("blogimage");
                out.println("<tr><td><h3>"+bname+"</h3></td><tr>");
                
                out.println("<tr><td><img src='foodimages/"+bimg+"' width='400' height='200'/></td><tr>");
             out.println("<tr><td>"+desp+"</td><tr>");
             
             out.println("<tr><td><a class='button hvr-shutter-in-vertical' href=viewblogquestion.jsp?bid="+bid+">VIEW QUESTIONS</a></td></tr>");
              out.println("<br>");
             out.println("<tr><td><a class='button hvr-shutter-in-vertical'  href=postblogquestion.jsp?bid="+bid+">POST QUESTIONS</a></td><tr>");
