                                        ...
                                        <div class="content-bottom-right" >
                                            ...
                                            <div class="section group">
                                                <div id="d1">
                                                    ...
                                                    <%
                                                        while (rs.next()) {
                                                            String sfname,slname,saddress,sregion,sarea,scity;
                                                            int spincode,sphone;
                                                    ...
                                                    <form >
                                                        ...
                                                        address<input type="description" name="id" value="<%=rs.getString("saddress")%>"/><br>
                                                        region<input type="description" name="id" value="<%=rs.getString("sregion")%>"/><br>
                                                        city<input type="description" name="id" value="<%=rs.getString("scity")%>"/><br>
