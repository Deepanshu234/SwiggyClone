                                            ...
                                            <div class="section group">
                                                <div id="d1">
                                                    <form>
                                                        ...
                                                        SELECT SELLER <select name ="s1" id="s1" >
                                                            <%
                                                                String f = "";
                                                                while (rs.next()) {
                                                        ...
                                                        <div class="entry">
                                                            <input type="submit" name="b1" value="block" >
                                                        </div>
                                                    </form>
                                                    ...
                                                    <%
                                                        ...
                                                        try {
                                                            ...
                                                            if (request.getParameter("b1") != null) {
                                                                ...
                                                                myconnection obj = new myconnection();
                                                                String r = "update  tbseller set status='0' where sellername=?";
                                                                PreparedStatement pst2 = obj.db.prepareStatement(r);
                                                                pst2.setString(1, selected_category);
                                                                ResultSet rs1;
