                                        ...
                                        <div class="content-bottom-right" >
                                            ...
                                            <div class="section group">
                                                <div id="d1">
                                                    ...
                                                    <%
                                                        ...
                                                        try {
                                                            ...
                                                            if (request.getParameter("b1") != null) {
                                                                ...
                                                                myconnection obj = new myconnection();
                                                                String r = "Select * from tbcategory where cname=?";
                                                    ...
                                                    %>
                                                    <form >
                                                        CATOGERY NAME   <input type="text" name="name" value="<%=rs.getString("cname")%>"/><br>
                                                        Satatus  <input type="text" name="status" value="<%=rs.getInt("status")%>"/><br>
                                                        ...
                                                        <input type="submit" value="save change" name="b2" />
                                                        ...
                                                        <%
                                                            try {
                                                                ...
                                                                if (request.getParameter("b2") != null) {
                                                                    ...
                                                                    String r = "update tbcategory set cname=?,rank=?,description=?,status=? where cname=?";
